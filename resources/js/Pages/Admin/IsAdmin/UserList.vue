          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            >
              <tr>
                ...
                <th scope="col" class="px-4 py-3">{{ t('roleShow.role') }}</th>
                ...
                >
                  ...
                  <td class="px-4 py-3">
                    <span
                      ...
                      :key="role.id"
                      class="inline-block bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-100 rounded px-2 py-1 mr-1 mb-1"
                    >
                      {{ role }}
                    </span>
                  </td>
