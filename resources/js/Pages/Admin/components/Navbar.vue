...
const flags = {
  en: '/storage/flag/us.webp',
  km: '/storage/flag/kh.png',
}

// Show correct flag
const currentFlag = computed(() => flags[locale.value] ?? '/storage/flag/us.webp')
      ...
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="" class="flex items-center justify-between mr-4">
            <img
              src="/storage/logo/logoCamboshare.png"
              class="mr-3 h-8 rounded-full"
              alt="Flowbite Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Camboshare</span>
          </a>
      ...
      <!-- set current flag  -->
        ...
        <ul class="py-1" role="none">
              <li>
                ...
                >
                  <div class="inline-flex items-center">
                    <img src="/storage/flag/us.webp" class="h-3.5 w-3.5 rounded-full mr-2" />
                    English (US)
                  </div>
                </a>
              </li>
              <li>
                ...
                >
                  <div class="inline-flex items-center">
                    <img src="/storage/flag/kh.png" class="h-3.5 w-3.5 rounded-full mr-2" />
                    ភាសាខ្មែរ​ (KH)
                  </div>
                </a>
              </li>
